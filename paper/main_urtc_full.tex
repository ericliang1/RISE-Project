...
\caption{One test scenario (8 masts, measured wind): 90\% regions of
the no-images baseline and of our method (conformal masks), with the
50\,m facility scale. Selection rule: among 8-mast scenarios, the one
jointly closest (log scale) to that subgroup's median baseline and
method radii, i.e., a typical case, not a best case.}
\label{fig:circles}
\end{figure}
