...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{../figures/paper/fig_data_components.pdf}
\caption{Each physics image, added on top of the input-only network,
tightens the guaranteed regions (DeepSets base, measured wind; 3-seed
ranges; the map added at each step is shown beside its row).}
\label{fig:comp}
\end{figure}
