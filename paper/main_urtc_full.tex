...
\begin{figure}[t]
\centering
\includegraphics[width=0.9\linewidth]{../figures/paper/fig_data_compare.pdf}
\caption{The study in one view: median 90\% region radius by method
and wind condition (log scale; bars span 3 training seeds; fractions
below the 50\,m facility scale annotated). Physics images halve the
exact-wind regions; under measured wind, direct inversion returns the
full site while the learned recipe holds 70--73\,m.}
\label{fig:ladder}
\end{figure}
