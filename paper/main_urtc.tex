...
\midrule
Exact-model reference & --- & 0.89--0.95 & 6.2--7.0 & --- \\
Labels only & DeepSets & 0.89 & 94--98 & 0\% \\
Labels only & GNN & 0.89--0.91 & 55--58 & --- \\
Labels only & Set Transformer & 0.89--0.91 & 69--75 & --- \\
+ physics images & DeepSets & 0.888--0.895 & 47.1--47.7 & 52.4\% \\
+ physics images & GNN & 0.891--0.902 & 46.2--47.5 & --- \\
+ physics images & Set Transformer & 0.887--0.901 & 46.2--47.3 & --- \\
Flow-based estimator & spline flow & 0.90--0.91 & 62.8--71.2 & --- \\
Flow + physics images & spline flow & 0.89--0.91 & 57.6--61.2 & --- \\
Classical score alone & no network & 1.00 & 282 (full site) & 0\% \\
\midrule
Channel ablation: evidence only & DeepSets & 0.88 & 65.0$^{1s}$ & --- \\
Channel ablation: sensitivity only & DeepSets & 0.90 & 98.5$^{1s}$ & --- \\
\bottomrule
\end{tabular}
\end{table}
...
Wind error & $10^\circ$ dir., 10\% speed, per step & Timing (batch 1) & maps 29.6\,ms, net 0.8\,ms; 30.4 med, 31.7 p95 \\
\bottomrule
\end{tabular}
\end{table}
