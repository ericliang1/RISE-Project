...
\begin{figure}[t]
\centering
\includegraphics[width=0.43\linewidth]{../figures/paper/fig_data_example.pdf}
...
deployment condition. The exact-model
...
radius percentiles p50/p75/p90 are 48/86/131\,m.

The fix is architecture-independent: the same images move a GNN from
56--57\,m and a Set Transformer from 69--71\,m into the same band
(46.2--47.5\,m), nine runs of three families within 1.5\,m. The classical score alone, calibrated with no
...
\begin{figure}[t]
\centering
\includegraphics[width=0.74\linewidth]{../figures/paper/fig_data_masts.pdf}
\caption{Sensor-count ablation (measured wind, seed-1 diagnostic;
prespecified bands of $n{=}690/635/675$ scenarios). More masts shrink
the guaranteed regions and raise the share at the facility scale; the
conformal guarantee remains marginal over the full distribution.}
\label{tab:masts}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[width=0.73\linewidth]{../figures/paper/fig_data_dist.pdf}
