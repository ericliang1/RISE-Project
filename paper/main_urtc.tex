...
Labels only & GNN & 0.893--0.896 & 55.4--57.6 & --- \\
Labels only & Set Transformer & 0.889--0.902 & 69.2--75.1 & --- \\
...
\bottomrule
\multicolumn{5}{l}{\footnotesize --- : per-scenario audit file not
retained for that run (summary statistics only).} \\
\end{tabular}
\end{table}
